...
public class Connect {
    ...
    public Connect() {
        try {
            conn = DriverManager.getConnection("jdbc:sqlite:GamingWorld.db");
    ...
    public ArrayList<String> selectDISTINCT(String[] columnsArray, String table) {
        ArrayList<String> data = new ArrayList<String>();
        String columns = String.join(", ", columnsArray);
        String sql = "SELECT DISTINCT " + columns + " FROM " + table;
        System.out.println(sql);
        try {
            stmt = conn.createStatement();
            rs = stmt.executeQuery(sql);
    ...
    public ArrayList<String> selectWhere(String[] columnsArray, String table, int[] whereSearch, String[] turseniq) {
